        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('view')
                    ->label('View')
                    ->icon('heroicon-m-eye')
                    ->url(fn (PoCustomer $record): string => \App\Filament\Resources\PoCustomerResource::getUrl('view', ['record' => $record]))
                    ->openUrlInNewTab(),

                Tables\Actions\Action::make('edit')
                    ->label('Edit')
                    ->icon('heroicon-m-pencil-square')
                    ->url(fn (PoCustomer $record): string => \App\Filament\Resources\PoCustomerResource::getUrl('edit', ['record' => $record]))
